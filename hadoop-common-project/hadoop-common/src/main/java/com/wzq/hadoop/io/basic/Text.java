...
import com.wzq.hadoop.io.WritableUtils;
...
public class Text extends BinaryComparable implements WritableComparable<BinaryComparable> {
    ...
    private static ThreadLocal<CharsetDecoder> DECODER_FACTORY = ThreadLocal.withInitial(() ->
    ...
    /**
     * Construct from anther {@link Text}.
     */
    ...
    public void set(String string) {
        try {
            ...
            throw new RuntimeException("Should not have happend " + e.toString());
        }
    }

    /**
     * Set to utf8 byte array
     */
     ...
     * If <code>len</code> is larger than the current capacity, the Text object;s capacity is increased
     * to match
     *
    ...
    /**
     * serialize write this object to out length users zero-compressed encoding
     *
